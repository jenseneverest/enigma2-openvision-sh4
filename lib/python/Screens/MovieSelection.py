...
l_moviesort = [
	...
	(str(MovieList.SORT_ALPHA_DATE_OLDEST_FIRST), _("alphabetic then oldest"), 'A1 A2 Z1'),
	(str(MovieList.SORT_ALPHAREV_DATE_NEWEST_FIRST), _("alphabetic then newest"),  'Z1 A2 A1'),
