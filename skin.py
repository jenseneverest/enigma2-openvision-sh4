...
from Tools.Directories import SCOPE_CONFIG, SCOPE_CURRENT_SKIN, SCOPE_FONTS, SCOPE_SKIN, fileExists, resolveFilename
			...
			if elem.tag == "screen":
				...
				if name:
					...
					if name in dom_screens:
						print "[skin] loadSkin: Screen already defined elsewhere:", name
						elem.clear()
					else:
